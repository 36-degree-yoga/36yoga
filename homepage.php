...
<div class="index_computer">
        <!-- Hero -->
        <header id='index_header' class="index_header"> 
...
<!-- index mobile  -->
    <div class="index_mobile">
        <header id="m_index_header" class="m_header">
            <!-- mobile hero 背景 -->
