...
<div class="custom container-fluid">
    ...
    <div class="custom_page d-flex justify-content-center no-wrap position-relative">
        ...
        <div class="position-absolute d-flex align-items-end logo_wrap"><svg id="logo_-_1" data-name="logo - 1" xmlns="http://www.w3.org/2000/svg" width="190.003" height="44.449" viewBox="0 0 190.003 44.449">
        ...
        <div class="delete_wrap position-absolute d-flex align-items-end"><a href="" data-toggle="modal" data-target="#leave"><img class="" src="svg/delete.svg" alt=""></a></div>
                    ...
                    <div class="option_container">
                        ...
                        <div class="option_button d-flex flex-column">
                            <div class="img_item_wrap d-flex">
                                <div class="img_item">
                                    <img id="img01" src="img/customize/custom_item_01.png" alt="">
                                </div>
                                <div class="img_item">
                                    <img id="img02" src="img/customize/custom_item_02.png" alt="">
                                </div>
                                <div class="img_item">
                                    <img id="img03" src="img/customize/custom_item_03.png" alt="">
                                </div>
                                <div class="img_item">
                                    <img style="height:250%;" id="img04" src="img/customize/custom_item_04.png" alt="">
                                </div>
                                <div class="img_item">
                                    <img style="height:250%;" id="img05" src="img/customize/custom_item_05.png" alt="">
                                </div>
    ...
    <div class="modal fade" id="add_cart_btn" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content modal-size">
                ...
                <div class="modal-body out_body">
                    <p class="mt-4">已加入 <a href="cart-step1.php">購物車 </a></p>
                </div>
    ...
    <div class="modal fade" id="leave" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content modal-size">
                ...
                <div class="modal-body out_body">
                    <p class="mx-auto">確定要離開設計頁面嗎？</p>
                </div>
                <div class="text-center mb-5">
                    <button class="btn btn_l p-0 del-btn-check" aria-label="Close" style="margin-right:10px;" onclick="leaveButton();">確認</button>
            ...
            <div class="modal-content m_modal-size">
                ...
                <div class="modal-body m_out_body d-flex align-items-center justify-content-center">
                    ...
                    <div class="m_cart_content ">
                        <p class="">已加入 <br><a href="cart-step1.php">購物車 </a></p>
                    </div>
                    <!-- m_out_hide -->
...
<script>
    $('#buy_btn').on('click', function(event) {
        ...
        $.get('custom_api.php', action, function(data) {
            console.log(data);
            // countCart(data.cart);
        }, 'json');
    });
    ...
    function leaveButton() {
        location.href = "product_custom_mat.php";
    }
</script>
