// loading
$('.index_computer').css('display','none');
$('#loading_screen').css('display','block');
// document.getElementById('loading_screen').style.display="none";
//             document.getElementById('index_computer').style.display="block";
$(window).ready(
    function(){
 setTimeout(() => {
    $('#loading_screen').removeClass('d-flex');
    $('#loading_screen').css('display','none');
    $('.index_computer').css('display','');
 }, 9000);
...
// find your soulmat
// check 變化
$('.hero_btn').on('mouseover', function () {
    $('.home_checkbtn').addClass('animation','.5s jump');
});
$('.hero_btn').on('mouseleave', function () {
    $('.home_checkbtn').removeClass('animation','.5s jump');
});
...
// });
    ...
    $('.reviews_btn').on('click',function(){　　　　
        ...
        if(n==4){
            let n=0;
            $('.memberhead_wrap img').attr('src', imgs[n+1]).css('transition','.5s');
...
// fixed button
$('.fixbtn').on('mouseenter',function(){
    $('.scrolltopbox').addClass('scrolltopbox_hover');
})
$('.fixbtn').on('mouseleave',function(){
    $('.scrolltopbox').removeClass('scrolltopbox_hover').css('transition-duration','.5s');
})

// fixed button 
// 點擊至最上

$('.fixbtn_wrap').on('click',function(){
    // console.log('yoyo')
    $('html,body').animate({ scrollTop:$('#index_home').offset().top },600);
});
...
$('#m_hpn_1').on('click', function () {
    $('.m_thermometer_move').css('width', '33%')
});

$('#m_hpn_2').on('click', function () {
    $('.m_thermometer_move').css('width', '66%')
});

$('#m_hpn_3').on('click', function () {
    $('.m_thermometer_move').css('width', '100%')
});
