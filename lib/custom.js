    ...
    $('.fold').on('click', function () {
      ...
      if ($(this).children().attr('src') == 'svg/custom/minus_nowrap.svg') {
        ...
        $('.fold').children().attr('src', 'svg/custom/plus_nowrap.svg')
        $('.fold').parent().next().hide();
    ...
    function channel2() {
      window.open("howto2.html", "如何挑選尺寸", "height=800,width=800,location=no,menubar=no,status=no", "channelmode,scrollbars")
    }
    //↑↑如何挑選尺寸跳窗↑↑
