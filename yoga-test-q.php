...
<div class="container-fluid hero position-relative">
    ...
    <div class="content-wrapper position-absolute d-flex">
        ...
        <div class="content d-flex align-items-start flex-column">
            ...
            <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="w-100">
                ...
                <div class="choice-next d-flex w-100 justify-content-center animate__animated animate__fadeInUp flex-column">
                    <div class="w-100 d-flex justify-content-center">

                        <button class="btn_f choice mx-5">上一步</button>
    ...
    <!-- 叉叉和logo -->
    <div class="delete position-absolute d-flex">
        <a href="<?= WEB_ROOT ?>homepage.php" style="margin-right:auto;">
            <div class="logo">
        ...
        <a href="<?php echo $test_ref ?>"><button type="button" class="close close-desktop" data-dismiss="modal" aria-label="Close">
        ...
        <a href="<?php echo $test_ref ?>"><button type="button" class="close close-mobile" data-dismiss="modal" aria-label="Close">
...
<script>
    ...
    let qqq = <?php echo json_encode($qqq); ?>;
    var move = hhh * qqq + 24;
    var movew = www * qqq + 24;
    // console.log(qqq);
    ...
    $(window).on('resize', function() {
        ...
        if (w < 992) {
            ...
            $('.thermometer_move').css('height', '100%');
    ...
    // let errr = "?php echo $resultErr ?>";
    // console.log('rrr' + errr);
    // if (errr) {
    //     alert('請選擇一項！');
    // }
